...
public class SignUpActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private void registerUser(){
        ...
        if(!Patterns.EMAIL_ADDRESS.matcher(email).matches()){
			...
			This method requires that the component
			is displayable, focusable, visible and have all it's ancestors be visible too. 
			It is best to call requestFocusInWindow() , as that method is not platform dependent*/
            return;
        }
