...
public class BuyFragment extends Fragment {
    ...
    ImageView pImage;
	//Android ImageView is one of the UI widget that is used to display images in the application.
	...
	Pass a custom instance of FirebaseApp to getInstance(FirebaseApp) which will initialize
	it with a storage location (bucket) specified via setStorageBucket(String).
	Otherwise, if you call getReference() without a FirebaseApp,
	the FirebaseStorage instance will initialize with the default FirebaseApp obtainable from getInstance().
